...
:clock: Now we will take time to make sure you have everything set up and take a short break. Afterwards you can go to [part 2](https://github.com/sleepypioneer/ContributingToNextcloudIntroductoryWorkshop/blob/master/partII.md)
